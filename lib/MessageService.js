...
class MessageService {
   ...
   */
  static async processMedia(mediaUrl, mediaType, messageId, mimeType = null) {
    try {
  ...
  static async processIncomingMessage(messageData, instanceName, connectionId, userId) {
    ...
    try {
      ...
      if (mediaUrl) {
        console.log(`📥 Processing ${messageType} media from UAZAPI... (MIME: ${mediaMimeType || 'unknown'})`);
        mediaProcessing = await this.processMedia(mediaUrl, messageType, messageKey.id, mediaMimeType);
