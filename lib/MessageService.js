...
class MessageService {
   ...
   * IMPORTANT: Uses contact_id to show messages from ALL connections with same contact
   */
  static async listMessages(conversationId, userId, { limit = 50, before = null } = {}) {
    ...
    // Query messages by contact_id to show ALL messages with this contact
    // This ensures users see messages from all connections with the same contact
