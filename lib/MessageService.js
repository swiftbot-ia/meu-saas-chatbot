...
class MessageService {
  ...
  static async sendTextMessage(conversationId, messageText, userId) {
    ...
    // Get connection details for API token
    const { data: connection, error: connError } = await supabase
      .from('whatsapp_connections')
      .select('instance_token, phone_number_id')
   ...
   */
  static async processIncomingMessage(messageData, connectionId, userId) {
    const supabase = createServerSupabaseClient();
   ...
   */
  static async getStats(userId, connectionId = null, dateRange = null) {
    const supabase = createServerSupabaseClient();
