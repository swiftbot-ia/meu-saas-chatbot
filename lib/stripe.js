...
export async function createSubscription({ 
  ...
  try {
    ...
    const { billingPeriod, connections, isTrialEligible, planPrice, trialDays = 1 } = planData
    ...
    const subscriptionData = {
      ...
      'payment_behavior': 'default_incomplete', // ← CRÍTICO
      'payment_settings[save_default_payment_method]': 'on_subscription', // ← IMPORTANTE
      'expand[]': 'latest_invoice.payment_intent', // ← NECESSÁRIO
    ...
    // ❌ NÃO adicionar default_payment_method aqui!
    // O Payment Element fará isso automaticamente
