...
class MediaServiceVPS {
    ...
    static async processMedia(mediaUrl, mediaType, messageId, metadata = {}) {
        try {
            ...
            try {
                // Construir URL pública para OpenAI Vision e UAZAPI
                // IMPORTANTE: Usar URL pública acessível (https://swiftbot.com.br)
                const publicUrl = `${process.env.NEXT_PUBLIC_SITE_URL || process.env.NEXT_PUBLIC_APP_URL || 'https://swiftbot.com.br'}${fileInfo.localPath}`;
