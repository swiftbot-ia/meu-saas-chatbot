...
-- Description: Adds columns for tag assignment, origin, webhook and custom fields when automation triggers
...
ALTER TABLE public.automations 
  ...
  ADD COLUMN IF NOT EXISTS action_custom_fields jsonb DEFAULT '{}';
...
COMMENT ON COLUMN public.automations.action_custom_fields IS 'Custom key-value fields to include in webhook payload';
