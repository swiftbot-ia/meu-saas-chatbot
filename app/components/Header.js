        ...
        <div className="hidden md:flex backdrop-blur-md bg-[#2a2a2a]/85 rounded-full px-6 shadow-lg">
          <div className="flex items-center justify-between h-[56px] gap-40">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="w-8 h-8 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                <svg width="32" height="32" viewBox="0 0 1564 1564" xmlns="http://www.w3.org/2000/svg">
                  {/* ... (caminhos SVG omitidos para brevidade) ... */}
            ...
            <nav className="flex items-center gap-1">
              <Link href="/pricing" className="px-4 py-1.5 text-[14px] font-medium text-white/80 hover:text-white transition-colors duration-200">
                Preço
              </Link>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-out ${showCTA ? 'max-w-[200px] opacity-100 ml-1' : 'max-w-0 opacity-0 ml-0'}`}>
                {/* // <-- MUDANÇA AQUI NESTA LINHA */}
                <Link href="/login" className="inline-flex items-center px-4 py-1.5 bg-[#04F5A0] hover:bg-[#03E691] text-black text-[14px] font-medium rounded-full transition-all duration-200 whitespace-nowrap">
                  Testar de graça
                </Link>
              </div>
            </nav>
