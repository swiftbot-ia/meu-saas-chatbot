...
export default function RegisterPage() {
    ...
    const [authView, setAuthView] = useState('register') // Inicia em register
    ...
    // CSS Classes extraídas do Design System
                            ...
                            <form onSubmit={handleAuth} className="space-y-6">
                                ...
                                {authView === 'register' && (
                                    <p className="text-[10px] text-gray-500 text-center px-4">
                                        Ao criar conta, você aceita nossos <a href="/terms" className="text-[#00FF99] hover:underline">Termos</a> e <a href="/privacy" className="text-[#00FF99] hover:underline">Privacidade</a>.
                                    </p>
                                )}
