        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            ...
            <div className="flex justify-center mb-10 animate-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
              <div className="bg-white/5 backdrop-blur-sm rounded-full p-1.5 flex">
                <button
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 animate-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
