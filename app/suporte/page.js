...
export default function SupportPage() {
  ...
  // MODIFICADO: Emojis removidos. SVGs serão adicionados no render.
  const categories = [
    ...
    { value: 'billing', label: 'Cobrança/Pagamento', svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-3.75l-3.75 3.75m3.75-3.75L18 16.5m-3.75-3.75v3.75m2.25-4.125c.621 0 1.125.504 1.125 1.125V18a1.125 1.125 0 01-1.125 1.125h-5.25A1.125 1.125 0 019 18v-2.625c0-.621.504-1.125 1.125-1.125H15M2.25 12h19.5" /></svg> },
    ...
    { value: 'agent', label: 'Agente IA', svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L1.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.25 12L15 14.25l-3.25-2.25L15 9.75l3.25 2.25z" /></svg> },
  ...
  // ADICIONADO: Função de Logout para o menu
    ...
    <div className="min-h-screen bg-[#0A0A0A] relative">
      ...
      <main className="relative z-10 max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        */}
            ...
            <div className="p-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {/* MODIFICADO: Estilo dos botões de categoria */}
                ...
                <div>
                  ...
                  {/* MODIFICADO: Estilo dos botões de prioridade */}
        ...
        {/* FAQ Section */}
        {/* MODIFICADO: Estilo do card de FAQ */}
