...
// Dados das FAQs para schema e exibição
...
// Schema FAQPage para SEO (Google Rich Snippets)
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [
    ...faqDataContent.payment.map(faq => ({
      "@type": "Question",
      "name": faq.question,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    ...faqDataContent.technology.map(faq => ({
      "@type": "Question",
      "name": faq.question,
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function FAQ() {
  ...
  // Usar dados centralizados para exibição
